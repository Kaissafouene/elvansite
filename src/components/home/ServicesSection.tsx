...
const ServicesSection = () => {
  const services = [{
    ...
    features: ["Tous services inclus", "Garantie satisfaction", "Protection longue durée"]
  }, {
    ...
    features: ["Lavage de maintien", "Retouche protection", "Conseils d'entretien"]
  }];
  return <section className="py-32 bg-gradient-to-br from-elvan-white via-elvan-light-gray/30 to-elvan-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-elvan-gray max-w-3xl mx-auto leading-relaxed">
            Des services de detailing automobile professionnels adaptés à tous vos besoins, 
            avec des techniques de pointe et des produits premium.
          </p>
        </div>

        {/* Grille de services */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 lg:gap-8 justify-items-start">
