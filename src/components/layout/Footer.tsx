...
const Footer = () => {
  return <footer className="bg-elvan-black text-elvan-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <img src="/lovable-uploads/05a477d1-3844-4ed9-aeb0-22816b7638c0.png" alt="ELVAN Detailing" className="h-20 w-auto" />
            </div>
            <p className="text-elvan-light-gray text-sm leading-relaxed mb-6">
              ...
              Spécialisé dans les finitions premium et la satisfaction client depuis 2025.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/" className="text-elvan-light-gray hover:text-elvan-white transition-all duration-300 flex items-center group">
                <span className="w-2 h-2 bg-elvan-navy rounded-full mr-3 group-hover:bg-elvan-white transition-colors"></span>
                Accueil
              </Link></li>
              <li><Link to="/services" className="text-elvan-light-gray hover:text-elvan-white transition-all duration-300 flex items-center group">
                <span className="w-2 h-2 bg-elvan-navy rounded-full mr-3 group-hover:bg-elvan-white transition-colors"></span>
                Nos Services
              </Link></li>
              <li><Link to="/about" className="text-elvan-light-gray hover:text-elvan-white transition-all duration-300 flex items-center group">
                <span className="w-2 h-2 bg-elvan-navy rounded-full mr-3 group-hover:bg-elvan-white transition-colors"></span>
                À Propos
              </Link></li>
              <li><Link to="/contact" className="text-elvan-light-gray hover:text-elvan-white transition-all duration-300 flex items-center group">
                <span className="w-2 h-2 bg-elvan-navy rounded-full mr-3 group-hover:bg-elvan-white transition-colors"></span>
                Contact
              </Link></li>
              <li><Link to="/faq" className="text-elvan-light-gray hover:text-elvan-white transition-all duration-300 flex items-center group">
            ...
            <div className="space-y-4">
              <div className="flex items-start group">
                ...
                <div className="text-sm text-elvan-light-gray">
                  <p className="font-medium text-elvan-white">N° 42 Espace Perle Bleu</p>
                  <p>2ème étage, B4</p>
              ...
              <div className="flex items-center group">
                ...
                <a href="tel:+21655729728" className="text-sm text-elvan-light-gray hover:text-elvan-white transition-colors">
                  +216 55 729 728
                </a>
              </div>
              <div className="flex items-center group">
                ...
                <a href="mailto:elvandetailing@gmail.com" className="text-sm text-elvan-light-gray hover:text-elvan-white transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-elvan-navy/10 p-3 rounded-lg border border-elvan-navy/20">
                <p className="text-xs text-elvan-light-gray">
                  <span className="text-elvan-white font-medium">Dimanche:</span> Fermé
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-elvan-navy/30">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-elvan-light-gray">
              ...
              <a href="https://www.kmsolutions.tn" target="_blank" rel="noopener noreferrer" className="text-elvan-white hover:text-elvan-navy transition-colors duration-300 font-medium underline underline-offset-2">
                www.kmsolutions.tn
              </a>
            </p>
